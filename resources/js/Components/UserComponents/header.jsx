...
import OrangeLogo from "../../image/UserImage/logo tring.png"
import profileImg from "../../image/UserImage/profile.png"
            ...
            <div ref={menuRef} className="container mx-auto flex flex-wrap items-center justify-between">
                ...
                >
                    <ul className="flex flex-col lg:flex-row list-none lg:ml-auto lg:items-center">
                        ...
                        <li className="nav-item">
                            <Link href={route('searchcatering')}
                            className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-[#F77E21] hover:opacity-75"
                            >
                        ...
                        <li className="nav-item">
                            <Link href={route('userprofilesettings')} className="lg:hidden px-3 pt-5 pb-2 flex items-center text-xs uppercase font-bold leading-snug text-[#F77E21] hover:opacity-75">

...
export default function ButtonHapusPhoto(){
  ...
  // Fungsi untuk menghapus foto
    const deletePhoto = () => {
    Inertia.delete('vendor/delete-profile');
    }

  // Fungsi untuk mengirim form
    const handleSubmit = (e) => {
    e.preventDefault();
    Inertia.post(route('/vendor/profile/update'), { photo });
    }
    return(
        <div>
            ...
            <ModalDelPhoto open={open} onClose={() => setOpen(false)}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-4 mt-8">
                        <button type="button" onClick={() =>   {Inertia.delete(route('vendor.deleteProfile'))}} className="btn bg-red-500 text-white font-semibold py-2 rounded-lg w-full">Hapus</button>

...
import ModalDelUser from "./modaldeleteUser";
import { HiTrash } from "react-icons/hi"
import { Inertia } from '@inertiajs/inertia';

export default function ButtonHapusUser ({userId}){
    const [open, setOpen] = useState(false)
    const handleDelete = () => {
        Inertia.delete(`/admin/deleteUser/${userId}`)
    };
    return(
        <div>
            ...
            <ModalDelUser open={open} onClose={() => setOpen(false)}>

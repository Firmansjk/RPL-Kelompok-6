...
const SideBarAdmin = () => {
  const menus = [
    { name: "Profile", link: "/admin/profilepage", icon: AiOutlineUser },
    { name: "List Katering", link: "/admin/listvendor", icon: HiMenu },
    { name: "List User", link: "/admin/listuser", icon: HiMenu }
  ];
    ...
    <section className="flex gap-6 hidden md:block lg:block">
      ...
      >
        <div className="py-3 flex justify-between">
          <img
            src={LogoOrange}
            className={open === true ? "block w-28" : "hidden"}
            alt=""
          ></img>
          <HiMenuAlt3
            size={26}

...
import sidePict from '../../image/UserImage/login_page.png';
import logowhite from '../../image/UserImage/logo tring white.png';
      ...
      <div className="container mx-auto">
        <div className="flex flex-col-reverse xl:h-[34em] content-center lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-12 bg-no-repeat bg-cover bg-center bg-repeat-space" style={{backgroundImage: `url(${sidePict})`}}>
            ...
            <Link href={route('registerpageuser')} className="bg-white mt-10 mb-6 px-6 py-2 rounded-lg text-[#F77E21] font-semibold transition-all hover:bg-[#e4e1e1]">
          ...
          <div className="w-full lg:w-1/2 py-8 px-6 md:py-16 md:px-12 lg:py-16 lg:px-12 flex flex-col justify-center">
            ...
            <form action="#">
              ...
              <div className="flex items-center justify-between">
                  ...
                  <Link href={route('forgetpassword')} className="text-xs text-right md:text-sm lg:text-sm font-semibold text-[#F77E21] hover:underline">
                    Lupa Password?
                  </Link>
              </div>
              <div className="mt-10 flex justify-center">
                <Link to="/"> {/* Disini Button untuk LOGIN user*/}

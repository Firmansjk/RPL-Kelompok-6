        ...
        <div className="flex flex-col xl:h-[34em] content-center lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 py-16 px-12 flex flex-col justify-center">
            ...
            <form action="#">
              ...
              <div>
                <label htmlFor="username" className="block mb-2 text-sm font-bold text-[#F77E21]">No. Telepon</label>
                <input type="username" name="username" id="username" className=" mb-4 bg-white border border-[#F77E21] text-black sm:text-sm rounded-lg block w-full p-2.5 placeholder-gray-400" placeholder="081xxxxxxxxx" required=""/>
              </div>
              <div>
